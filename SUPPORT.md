...
Hello, thank you for using Prettier Config! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-prettier-config/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-prettier-config/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-prettier-config/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - Prettier Config version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-prettier-config/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-prettier-config/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Prettier Config:
...
<div align="center">
  Thank you for using Prettier Config!
  <br>
